            ...
            <div className="app__headerButtons">
              ...
              <Button className={classes.button}>
                <a
                  href={ResumePDF}
                  download
                  className="app__headerButtonsResume"
                >
                  Resume
                </a>
              </Button>
          ...
          <section id="Intro">
            <div className="app__introduction">
              <article>
                ...
                <h1>
                  I'm <strong>Daneil Nguyen</strong>, a current college student
                  who is a tech enthusiast and aspiring full-stack developer 💻
                </h1>
              </article>
            </div>
          </section>
          ...
          <section id="About">
            <div className="app__about">
              <div className="app__aboutDescription">
                ...
                <br />
                <p>
                  I am based in the DMV and am attending the University of
                  Maryland, College Park as an upcoming freshman this fall. I
                  will be studying Computer Science with a focus on Data
                  Science.
                </p>
                <br />
                <p>
                  My overarching goal is to be able to utilize technology to
                  bring forth positive change in this world. However, I love
                  programming and have gained an interest in web development and
                  UI/UX recently. My goal is to learn full-stack development so
                  that I can create and deploy modern web applications.
                </p>
                <br />
            ...
            <div className="app__contact">
              <div className="app__contactText">
                ...
                <p>
                  ...
                  internships, etc. Otherwise, you can ask me questions and
                  simply say hi!
                </p>
